#!/usr/bin/env python3
"""
The InputReader class finds and stores input info for DataSection subclasses.

The InputReader class searches for the "inputs" from an input .txt file to be
